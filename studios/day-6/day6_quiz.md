# Day 6 Quiz: Timeframe Correlation
...
- [x] C) To ensure every trade entry is confirmed by higher-timeframe structural alignment
...
- [x] B) To provide a precise execution trigger AFTER higher timeframes are confirmed
...
- [x] B) Dropping to lower timeframes to find signals that confirm what you already want to do
...
- [x] C) When multiple timeframes all point to the same price level simultaneously
